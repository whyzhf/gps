...
*/
	...
	public class Strings {
		 ...
		 *
		 * @param keysvalues
		 *            String 例:keysvalues="key1","value1","key2","value2";
		 *
		 * @return String 状态码
		 *
		 */
	...
	public class Lists {
		 ...
		 *
		 * @param c
		 *            int要删除的数量，如果为负数则从List的尾部检查并删除符合的记录
		 *
		 * @param value
		 *            byte[]要匹配的值
		 *
		 ...
		 *
		 * @param c
		 *            int 要删除的数量，如果为负数则从List的尾部检查并删除符合的记录
		 *
		 * @param value
		 *            String 要匹配的值
		 *
		 ...
		 *
		 * @param end
		 *            int 记录的结束位置（如果为-1则表示最后一个，-2，-3以此类推）
		 *
		 * @return 执行状态码
		 *
		 */
	...
	public class Keys {
		 ...
		 * 
		 * @param parame
		 *            SortingParams 定义排序类型或limit的起止位置.
		 * 
